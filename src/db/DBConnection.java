 ...
 * 		DBConnection
 * 		/         |
 * 		SQLConnection(abstract)		NoSQLConnection(abstract)
 *		/		|				/		|
 *	MYSQL(concret)		..				MongoDBConnection(concret)
 */
   ...
   /**
	...
	public boolean addUser(String firstname, String lastname, String user_id, String password);
